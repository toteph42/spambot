...
// front end modules
$GLOBALS['FE_MOD']['user']['SpamBot-IP']            = 'SpamBotBundle\Module\SpamBotIP';
$GLOBALS['FE_MOD']['user']['SpamBot-Mail']          = 'SpamBotBundle\Module\SpamBotMail';
...
if (TL_MODE === 'BE') {
    ...
    $GLOBALS['TL_HOOKS']['parseFrontendTemplate'][] = [ 'SpamBotBundle\Module\SpamBotMod', 'clearTemplate' ];
    // insert tag replacement
    $GLOBALS['TL_HOOKS']['replaceInsertTags'][]     = [ 'SpamBotBundle\Module\SpamBotMod', 'replaceInsertTag' ];
    // validate email text fields - need to do it this way, because else we wont catch comment e-mails
    $GLOBALS['TL_FFL']['text']                      = 'SpamBotBundle\Module\SpamBotTextField';
    $GLOBALS['TL_HOOKS']['addCustomRegexp'][]       = [ 'SpamBotBundle\Module\SpamBotMod', 'checkMail' ];
}
